 ...
 *
 * The only supported env prefix is TRADESMEN_SECURITY_CENTER_*. Legacy aliases
 * (TSC_*, SECURITY_CENTER_*, SECURITY_CENTER_API_KEY, SECURITY_CENTER_TOKEN,
 * FEATURE_SECURITY_CENTER_API) are never read.
 *
...
final class ConnectorEnvNames
{
    ...
    public const TRADESMEN_SECURITY_CENTER_DEFAULT_ALLOWED_IPS = 'TRADESMEN_SECURITY_CENTER_DEFAULT_ALLOWED_IPS';
    public const TRADESMEN_SECURITY_CENTER_TRUSTED_PROXY_CIDRS = 'TRADESMEN_SECURITY_CENTER_TRUSTED_PROXY_CIDRS';
    public const TRADESMEN_SECURITY_CENTER_CLIENT_IP_HEADERS = 'TRADESMEN_SECURITY_CENTER_CLIENT_IP_HEADERS';
    public const TRADESMEN_SECURITY_CENTER_ACCESS_LOG_RETENTION_DAYS = 'TRADESMEN_SECURITY_CENTER_ACCESS_LOG_RETENTION_DAYS';
    public const TRADESMEN_SECURITY_CENTER_NONCE_LOG_RETENTION_SECONDS = 'TRADESMEN_SECURITY_CENTER_NONCE_LOG_RETENTION_SECONDS';
    ...
    /**
     * Canonical wrapper for an exported connector setup token. The token body
     * keeps the cross-app `tsc1_` prefix; only the env wrapper is canonicalized.
     */
    public const TRADESMEN_SECURITY_CENTER_CONNECTOR_TOKEN = 'TRADESMEN_SECURITY_CENTER_CONNECTOR_TOKEN';

    /**
     * Every canonical connector configuration env name, in documentation order.
     *
     * @return list<string>
     */
    public static function canonicalNames(): array
    {
        return [
            ...
            self::TRADESMEN_SECURITY_CENTER_DEFAULT_ALLOWED_IPS,
            self::TRADESMEN_SECURITY_CENTER_TRUSTED_PROXY_CIDRS,
            self::TRADESMEN_SECURITY_CENTER_CLIENT_IP_HEADERS,
            self::TRADESMEN_SECURITY_CENTER_ACCESS_LOG_RETENTION_DAYS,
            self::TRADESMEN_SECURITY_CENTER_NONCE_LOG_RETENTION_SECONDS,
